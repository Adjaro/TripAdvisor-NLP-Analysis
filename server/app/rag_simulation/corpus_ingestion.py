...
class BDDChunks:
    ...
    def __init__(self, embedding_model: str, path: str):
        ...
        self.client = chromadb.PersistentClient(
            path="./ChromaDB1", settings=Settings(anonymized_telemetry=False)
        )
    ...
    #     """
    #     Configure et retourne un client ChromaDB.
    #     """
    #     # Création d'une instance de client ChromaDB
    #     client = chromadb.Client(
    #         Settings(
    #             chroma_db_impl="duckdb+parquet",  # Backend par défaut (DuckDB avec Parquet)
    #             persist_directory="./chroma_db"  # Chemin pour persister les données
    #         )
    #     )
    #     return client
    ...
    def _create_collection(self, path: str) -> None:
        ...
        try:
            ...
            # self.chroma_db = self.client.get_collection(name=collection_name
            # )
        except Exception as e:
